...
(UUID(), 'Administrador Sistema', 'admin@mediconnect.com', '$2a$10$wmevMfK6JeWnagv6C08A7ueLp5aHRlrVL.9tDkJfZubuZKhg2/ZhC', 'admin', '(11) 99999-0001', 1, 1, '{"theme":"light","notifications":true,"language":"pt-BR"}', NOW(), NOW()),
(UUID(), 'Dr. João Silva', 'joao.silva@mediconnect.com', '$2a$10$iMfbGbpVMmftpRP1dwSnx.mJLyfABK/2MTM.hMvqFEVZ2bpEzSNz.', 'doctor', '(11) 98765-4321', 1, 1, '{"theme":"light","notifications":true,"language":"pt-BR"}', NOW(), NOW()),
(UUID(), 'Maria Santos', 'maria.santos@mediconnect.com', '$2a$10$RFqJaXUIhBRJeRdpYXLB..0Xg2.jjAwy2Wlx8/5XB47gBBfg.Lx26', 'receptionist', '(11) 98765-1234', 1, 1, '{"theme":"light","notifications":true,"language":"pt-BR"}', NOW(), NOW());
