/**
 * Validadores customizados para o sistema MediConnect
 */
...
/**
 * Valida se email é de domínio médico comum
 * @param {string} email - Email a ser validado
 * @returns {boolean} True se domínio médico
 */
const isMedicalDomain = (email) => {
  if (!email) return false;
  
  const medicalDomains = [
    'gmail.com', 'hotmail.com', 'outlook.com', 'yahoo.com',
    'mediconnect.com', 'hospital.com', 'clinica.com', 'saude.com'
  ];
 ...
 */
const isValidAge = (birthDate, minAge = 0) => {
 ...
 */
const isWithinBusinessHours = (time, startTime = '08:00', endTime = '18:00') => {
 ...
 * @returns {boolean} True se válido
 */
const isValidMonetaryValue = (value, min = 0, max = 1000000) => {
